  ...
  return (
    <>
      <motion.div 
        ...
        className="w-80 bg-white/80 backdrop-blur-xl border-r border-slate-200 h-screen fixed left-0 top-0 overflow-y-auto z-50 hidden lg:flex flex-col shadow-2xl"
      >
        {/* Logo Area */}
        <div className="p-8 border-b border-slate-100">
          ...
          <p className="text-xs text-slate-400 mt-2 font-medium tracking-wider">INTELLIGENT CLASSIFIER</p>
        </div>
